# forklift-fleet-check - NestJS API + Astro Frontend
...
- **API**: `ghcr.io/TituxMetal/forklift-fleet-check-api`
- **Web**: `ghcr.io/TituxMetal/forklift-fleet-check-web`
...
- `ghcr.io/TituxMetal/forklift-fleet-check-api:latest`
- `ghcr.io/TituxMetal/forklift-fleet-check-web:latest`
...
- **Local Development**: Images built with `scripts/docker-build.sh` use Docker Hub
  (`lgdweb/forklift-fleet-check-*`) for quick testing and iteration
- **Production Releases**: CI automatically builds and pushes to GitHub Container Registry
  (`ghcr.io/TituxMetal/forklift-fleet-check-*`) for official releases
